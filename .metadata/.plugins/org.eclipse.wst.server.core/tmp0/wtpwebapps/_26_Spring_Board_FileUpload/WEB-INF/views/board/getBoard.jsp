							...
							<div id="attZone">
								...
								varStatus="status">
									...
									<c:if test="${status.last }">
										...
										<c:choose>
											<c:when test="img${boardFile.boardFileCate eq 'image' }">
												<img id="${boardFile.boardNo }_${boardFile.boardFileNo }"
											...
											<c:otherwise>
												<img id="img${boardFile.boardNo }_${boardFile.boardFileNo }"
										...
										<p id="fileName${boardFile.boardNo }_${boardFile.boardFileNo }"
	...
	<script>
		...
		$(function() {
			...
			$("updateForm").on("submit", (e) => {
				//배열 담겨있는 파일ㄷ르을 input으로 옮겨서 submit
				dt = new DataTransfer();
				...
				//수정된 파일들(changedFiles 배열) input으로 옮겨 담기
				dt2 = new DataTransfer();
				
				for(f in chagedFiles){
