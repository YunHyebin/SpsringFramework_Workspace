	...
	<script>
		...
		$(function (){
			...
			$("#insertForm").on("submit", () => {
				//폼 submit 전에 마지막으로 uploadFiles에 있는 파일들을 
		...
		//미리보기 메소드
		//미리보기 영역에 들어갈 img태그 생성 및 선택된 파일을 
		...
		const makeDiv = (img, file) => {
			...
			btn.onclick = (e) => {
				...
				//input type="file"은 첨부된 파일을 fileList의 형태로 관리하고 있다.
				//fileList에는 일반적인 File객체를 넣을 수 없다.
